  ...
  requirejs.config(
    {
      ...
      
      {
        ...
        'pouchdb': 'libs/pouchdb-7.2.1/pouchdb',
        'pouchfind': 'libs/pouchdb-7.2.1/pouchdb.find'
      }
...
require(['ojs/ojbootstrap', 'knockout', 'appController', 'ojs/ojlogger', 'ojs/ojrouter', 'ojs/ojknockout',
  ...
  function (Bootstrap, ko, app, Logger, Router, PouchDB) { // this callback gets executed when all required modules are loaded
